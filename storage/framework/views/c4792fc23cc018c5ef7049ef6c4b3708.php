...
<body>
    ...
    <header>
        ...
        <div class="header-links" style="display: flex; gap: 1rem; align-items: center;">
            <a href="/<?php echo e($locale); ?>" target="_blank">View Main Site</a>
            <form action="/<?php echo e($locale); ?>/admin/logout" method="POST" style="margin: 0; padding: 0; display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="container">
        ...
        <form method="GET" action="" id="monthFilterForm" style="margin-bottom: 1.5rem; display: flex; align-items: center; gap: 1rem; background: var(--bg-light); padding: 0.85rem 1.25rem; border-radius: 10px; border: 1px solid var(--border-color);">
            ...
            <select name="month" onchange="this.form.submit()" style="padding: 0.4rem 0.8rem; border-radius: 6px; border: 1px solid #cbd5e1; font-weight: 600; font-size: 0.88rem; color: var(--primary-dark); cursor: pointer; background: #fff;">
                ...
                <option value="<?php echo e($opt['value']); ?>" <?php echo e($opt['selected'] ? 'selected' : ''); ?>><?php echo e($opt['label']); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <option value="__3m" <?php echo e($selectedMonth === '__3m' ? 'selected' : ''); ?>>Next 3 Months (combined)</option>
                <option value="__6m" <?php echo e($selectedMonth === '__6m' ? 'selected' : ''); ?>>Next 6 Months (combined)</option>
            </select>
        ...
        <div class="stats-grid" style="margin-bottom: 2rem;">
            <div class="stat-card">
                ...
                <div class="value"><?php echo e($cars->sum('quantity')); ?> Vehicles</div>
            </div>

            <div class="stat-card">
                <h3>Confirmed Bookings</h3>
                <div class="value"><?php echo e($selectedMonthData['bookings']); ?> Confirmed</div>
                <div style="font-size:0.78rem;color:var(--text-muted);margin-top:0.25rem;"><?php echo e($filterDate->format('F Y')); ?></div>
            </div>

            <div class="stat-card">
                <h3>Pending Bookings</h3>
                <div class="value"><?php echo e($selectedMonthData['pending']); ?> Pending</div>
                <div style="font-size:0.78rem;color:var(--text-muted);margin-top:0.25rem;"><?php echo e($filterDate->format('F Y')); ?></div>
            </div>

            <div class="stat-card" style="border-left: 4px solid #10b981;">
                <h3>Projected Revenue</h3>
                <div class="value" style="color: #10b981;"><?php echo e(number_format($selectedMonthData['revenue'])); ?> DH</div>
                <div style="font-size:0.78rem;color:var(--text-muted);margin-top:0.25rem;"><?php echo e($filterDate->format('F Y')); ?> · Confirmed only</div>
            </div>
        </div>
        ...
        <div class="stats-grid" style="margin-bottom: 2rem; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
            <div class="stat-card" style="border-left: 4px solid #ef4444;">
                ...
                <div class="value" style="color: #ef4444;"><?php echo e(number_format($selectedMonthData['expenses'])); ?> DH</div>
                <div style="font-size: 0.8rem; color: var(--text-muted); margin-top: 0.25rem;">Fixed + Manual · <?php echo e($filterDate->format('M Y')); ?></div>
            </div>

            <div class="stat-card" style="border-left: 4px solid #c5a059;">
                <h3>Net Projected Profit</h3>
                <div class="value" style="color: <?php echo e($selectedMonthData['net'] >= 0 ? '#c5a059' : '#ef4444'); ?>;"><?php echo e(number_format($selectedMonthData['net'])); ?> DH</div>
            ...
            <div class="stat-card" style="grid-column: span 2;">
                ...
                <div class="value" style="font-size: 1.5rem; padding-top: 0.5rem;">
                    <strong><?php echo e($visits24h); ?></strong> <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: 500;">last 24h</span>
                    &nbsp;|&nbsp; <strong><?php echo e($visits7d); ?></strong> <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: 500;">7 days</span>
                    &nbsp;|&nbsp; <strong><?php echo e($visits30d); ?></strong> <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: 500;">30 days</span>
                </div>
            </div>
        </div>
                ...
                <div style="overflow-x:auto;">
                    <div style="min-width: 800px;">
                        ...
                        <div style="display:grid; grid-template-columns: 200px repeat(15, 1fr); border-bottom:2px solid var(--border-color); font-weight:700; text-align:center; padding-bottom:0.5rem; font-size:0.78rem;">
                            ...
                            <?php for($d = 0; $d < 15; $d++): ?>
                            <?php $dayDate = now()->addDays($d); ?>
                            <div><?php echo e($dayDate->format('d M')); ?></div>
                            <?php endfor; ?>
                        </div>

                        <!-- Grid Rows -->
                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php for($unit = 1; $unit <= $car->quantity; $unit++): ?>
                            <div style="display:grid; grid-template-columns: 200px repeat(15, 1fr); border-bottom:1px solid var(--border-color); min-height:50px; align-items:center; font-size:0.8rem; padding:0.25rem 0;">
                                <div style="font-weight:600; padding-left:0.5rem;">
                                    ...
                                    <span style="font-size:0.7rem; color:var(--text-muted); font-weight:normal;">(Unit #<?php echo e($unit); ?> of <?php echo e($car->quantity); ?>)</span>
                                </div>
                                ...
                                <div style="height:100%; border-left: 1px solid rgba(0,0,0,0.05); display:flex; align-items:center; justify-content:center; padding: 2px;">
                                    ...
                                    <div style="width:100%; height:80%; border-radius:4px; font-size:0.65rem; font-weight:700; text-align:center; display:flex; align-items:center; justify-content:center;
                                        background: <?php echo e($hasBooking->status === 'confirmed' ? '#d1fae5' : '#fef3c7'); ?>;
                                        color: <?php echo e($hasBooking->status === 'confirmed' ? '#065f46' : '#b45309'); ?>;
                                        border: 1px solid <?php echo e($hasBooking->status === 'confirmed' ? '#10b981' : '#f59e0b'); ?>;"
                                        title="Booking #<?php echo e($hasBooking->booking_reference); ?> by <?php echo e($hasBooking->customer_name); ?> (<?php echo e($hasBooking->pickup_datetime->format('d M')); ?> - <?php echo e($hasBooking->return_datetime->format('d M')); ?>)">
                                        <?php echo e(substr($hasBooking->customer_name, 0, 8)); ?>
            ...
            <div class="panel" style="margin-bottom: 2rem;">
                ...
                <div id="alerts-list-container">
                    ...
                    <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($inspAlert || $eolAlert): ?>
                            <?php $alertCount++; ?>
                            <div style="padding:1rem; border-radius:8px; margin-bottom:1rem; display:flex; align-items:center; gap:1rem;
                                background: <?php echo e($eolAlert ? '#fef2f2' : '#fffbeb'); ?>;
                                border-left: 5px solid <?php echo e($eolAlert ? '#ef4444' : '#f59e0b'); ?>;">
                                <span style="font-size:1.5rem;"><?php echo e($eolAlert ? '🚫' : '🔧'); ?></span>
                                <div style="flex-grow:1;">
                                    <h4 style="margin:0; font-size:0.95rem; color:var(--primary-dark);"><?php echo e($car->brand); ?> <?php echo e($car->model); ?></h4>
                                    <p style="margin:2px 0 0 0; font-size:0.82rem; color:var(--text-muted);">
                                        <?php if($eolAlert): ?>
                                            <strong>Immediate Retirement Alert!</strong> Exceeds the Moroccan mandatory 5-year limit for rental cars (EOL date: <?php echo e($eolDate->format('M Y')); ?>).
                                        <?php else: ?>
                                            <strong>Technical Inspection Due Soon!</strong> First 4-year inspection threshold is scheduled for <?php echo e($firstInspection->format('M Y')); ?>.
                                        <?php endif; ?>
                                    </p>
                                </div>
                            </div>
        ...
        <div id="extras-tab" class="tab-content" style="display:none;">
            <div class="admin-grid">
                ...
                <div class="panel">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong><?php echo e($extra->name); ?></strong></td>
                                <td><code><?php echo e($extra->slug); ?></code></td>
                                <td><strong><?php echo e($extra->price); ?> DH</strong></td>
                                <td>
                                    <span class="badge" style="background: <?php echo e($extra->type === 'per_day' ? '#e0f2fe; color:#0369a1' : '#f3e8ff; color:#6b21a8'); ?>;">
                                        <?php echo e($extra->type === 'per_day' ? '/day' : 'Flat'); ?>

                                    </span>
                                </td>
                                <td style="font-size:0.8rem; color:#64748b;"><?php echo e($extra->description ?? '—'); ?></td>
                                <td>
                                    <a href="#" onclick="openEditExtraModal(<?php echo e(json_encode($extra)); ?>)" style="color: #c5a059; margin-right: 0.5rem; text-decoration: none; font-weight: 600;">Edit</a>
                                    <form action="/<?php echo e($locale); ?>/admin/extras/<?php echo e($extra->id); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Delete this extra?')">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="panel">
                    <h2>Add New Extra</h2>
                    <form action="/<?php echo e($locale); ?>/admin/extras" method="POST">
                        <?php echo csrf_field(); ?>
        ...
        <div id="fleet-tab" class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <span style="display:inline-block; width:28px; height:28px; line-height:28px; border-radius:50%; background:var(--primary-dark); color:white; font-size:0.75rem; font-weight:700; text-align:center;"><?php echo e($car->display_order ?? 99); ?></span>
                            </td>
                            <td><strong><?php echo e($car->brand); ?> <?php echo e($car->model); ?></strong></td>
                            <td>
                                <?php if($modelYear): ?>
                                    <?php echo e($modelYear); ?>/<?php echo e(str_pad($modelMonth, 2, '0', STR_PAD_LEFT)); ?>
                            ...
                            <td><?php echo e($car->base_price); ?> DH</td>
                            <td>
                                <span style="font-weight:600; color: #ef4444;">
                                    <?php echo e($car->loan_cost + $car->insurance_cost + $car->maintenance_cost + $car->fuel_cost + $car->other_cost); ?> DH
                                </span>
                            </td>
                            <td style="font-size:0.78rem; min-width:140px;">
                                <?php if($nextInspection): ?>
                                    <div style="color: <?php echo e($inspDays !== null && $inspDays <= 60 ? '#ef4444' : ($inspDays !== null && $inspDays <= 180 ? '#f59e0b' : '#10b981')); ?>; font-weight:600;">
                                        🔧 <?php echo e($nextInspection->format('M Y')); ?>

                                        <?php if($inspDays !== null && $inspDays <= 60): ?><span style="font-size:0.7rem;"> ⚠️ Soon</span><?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                <?php if($eolDate): ?>
                                    <div style="color: <?php echo e($eolDays !== null && $eolDays <= 90 ? '#ef4444' : ($eolDays !== null && $eolDays <= 365 ? '#f59e0b' : '#64748b')); ?>; margin-top:2px;">
                                        🚫 EOL: <?php echo e($eolDate->format('M Y')); ?>

                                        <?php if($eolDays !== null && $eolDays <= 90): ?><span style="font-size:0.7rem;"> ⚠️ Retire</span><?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                <?php if(!$modelYear): ?><span style="color:#94a3b8;">No date set</span><?php endif; ?>
                            </td>
                            <td>
                                <a href="#" id="btn-edit-car-<?php echo e($car->id); ?>" onclick="openEditModal(<?php echo e(json_encode($car)); ?>)" style="color: #c5a059; margin-right: 0.5rem; text-decoration: none; font-weight: 600;">Edit</a>
                                <form action="/<?php echo e($locale); ?>/admin/cars/<?php echo e($car->id); ?>" method="POST" onsubmit="return confirm('Remove vehicle from database?')" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" style="color:red; background:none; border:none; cursor:pointer; font-weight: 600;">Delete</button>
                                </form>
            ...
            <div class="panel">
                ...
                <form action="/<?php echo e($locale); ?>/admin/cars" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="number" name="model_year" min="2000" max="<?php echo e(date('Y')); ?>" placeholder="<?php echo e(date('Y')); ?>">
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label>Model Month</label>
                            <select name="model_month">
                                <option value="">— Select —</option>
                                <?php $__currentLoopData = ['Jan'=>1,'Feb'=>2,'Mar'=>3,'Apr'=>4,'May'=>5,'Jun'=>6,'Jul'=>7,'Aug'=>8,'Sep'=>9,'Oct'=>10,'Nov'=>11,'Dec'=>12]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mn => $mv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mv); ?>"><?php echo e($mn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="admin-grid">
            <div class="panel">
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $seasonalPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><strong><?php echo e($rule->name); ?></strong></td>
                            <td><?php echo e($rule->car ? $rule->car->brand . ' ' . $rule->car->model : 'All Vehicles'); ?></td>
                            <td><?php echo e($rule->start_date); ?></td>
                            <td><?php echo e($rule->end_date); ?></td>
                            <td style="text-align:center;"><strong><?php echo e($rule->min_days ?? 1); ?>+ days</strong></td>
                            <td><?php echo e($rule->adjustment_type == 'percentage' ? 'Percentage' : 'Flat Price Override'); ?></td>
                            <td>
                                <?php echo e($rule->adjustment_type == 'percentage' ? ($rule->value > 1.0 ? '+' . (($rule->value - 1.0)*100) . '%' : ($rule->value*100) . '%') : ($rule->value . ' DH')); ?>

                            </td>
                            <td>
                                <form action="/<?php echo e($locale); ?>/admin/pricing/<?php echo e($rule->id); ?>" method="POST" onsubmit="return confirm('Remove this rule?')" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
            ...
            <div class="panel">
                ...
                <form action="/<?php echo e($locale); ?>/admin/pricing" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
        ...
        <div id="expenses-tab" class="tab-content" style="display: none;">
            <div class="admin-grid">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong><?php echo e($car->brand); ?> <?php echo e($car->model); ?></strong></td>
                                <td><?php echo e($car->quantity); ?></td>
                                <td><?php echo e(number_format($car->loan_cost)); ?> DH <span style="font-size: 0.75rem; color: var(--text-muted);">/car</span></td>
                                <td><?php echo e(number_format($car->insurance_cost)); ?> DH <span style="font-size: 0.75rem; color: var(--text-muted);">/car</span></td>
                                <td><strong><?php echo e(number_format($carFixed)); ?> DH</strong></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr style="background: var(--bg-light); font-weight: 700; border-top: 2px solid var(--border-color);">
                                ...
                                <td style="color: #ef4444; font-size: 1.1rem;"><?php echo e(number_format($totFixed)); ?> DH</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="panel">
                    ...
                    <form action="/<?php echo e($locale); ?>/admin/expenses" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: flex-end;">
                            ...
                            <div class="form-group" style="flex: 2;">
                                ...
                                <input type="date" name="spent_at" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
            ...
            <div class="panel" style="margin-top: 2rem;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo e($exp->spent_at->format('Y-m-d')); ?></td>
                            <td>
                                <strong><?php echo e($exp->description); ?></strong>
                            ...
                            <td><strong style="color: #ef4444;"><?php echo e(number_format($exp->amount)); ?> DH</strong></td>
                            <td>
                                <form action="/<?php echo e($locale); ?>/admin/expenses/<?php echo e($exp->id); ?>" method="POST" onsubmit="return confirm('Delete this expense entry?')" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" style="color:red; background:none; border:none; cursor:pointer; font-weight:600;">Delete</button>
                                </form>
                ...
                <div style="margin-top: 2.5rem; background: var(--bg-light); border-radius: 12px; padding: 1.5rem 2rem; display: flex; justify-content: space-between; align-items: center; border: 1px solid var(--border-color);">
                    <div>
                        ...
                        <p style="font-size: 0.85rem; color: var(--text-muted); margin-top: 0.25rem;">
                            Fixed: <strong><?php echo e(number_format($totFixed)); ?> DH</strong> | 
                            Variable: <strong><?php echo e(number_format($totCustomThisMonth)); ?> DH</strong>
                        </p>
                    </div>
                    <div style="text-align: right;">
                        ...
                        <div style="font-size: 2rem; font-weight: 800; color: #ef4444; line-height: 1;"><?php echo e(number_format($totFixed + $totCustomThisMonth)); ?> DH</div>
                    </div>
                </div>
            </div>
        ...
        <div id="bookings-tab" class="tab-content" style="display: none;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code><?php echo e($booking->booking_reference); ?></code></td>
                        <td>
                            <?php echo e($booking->customer_name); ?>

                            <?php if($booking->extras && count($booking->extras) > 0): ?>
                                <div style="display: flex; flex-wrap: wrap; gap: 0.2rem; margin-top: 0.25rem;">
                                    <?php $__currentLoopData = $booking->extras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span style="font-size: 0.65rem; padding: 0.1rem 0.3rem; background: #e0f2fe; color: #0369a1; border-radius: 4px; font-weight: bold; text-transform: uppercase;">
                                            <?php echo e($extra == 'insurance' ? 'CDW' : $extra); ?>
                        ...
                        <td><a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $booking->customer_phone)); ?>" target="_blank"><?php echo e($booking->customer_phone); ?></a></td>
                        <td><?php echo e($booking->car ? $booking->car->brand . ' ' . $booking->car->model : 'Deleted Car'); ?></td>
                        <td><?php echo e($booking->pickup_datetime->format('Y-m-d H:i')); ?></td>
                        <td><?php echo e($booking->return_datetime->format('Y-m-d H:i')); ?></td>
                        <td><strong><?php echo e(number_format($booking->total_price)); ?> DH</strong></td>
                        <td>
                            <span class="badge badge-source-<?php echo e($booking->source == 'website' ? 'web' : ($booking->source == 'whatsapp' ? 'whatsapp' : 'ota')); ?>">
                                <?php echo e(strtoupper($booking->source)); ?>
                        ...
                        <td>
                            <div style="display:flex; gap:0.5rem; align-items:center;">
                                <form action="/<?php echo e($locale); ?>/admin/bookings/<?php echo e($booking->id); ?>/status" method="POST" style="display:flex; gap:0.25rem; margin:0;">
                                    <?php echo csrf_field(); ?>
                                    <select name="status" style="padding: 0.2rem; font-size:0.75rem;">
                                        ...
                                        <option value="confirmed" <?php echo e($booking->status == 'confirmed' ? 'selected' : ''); ?>>Confirm</option>
                                        <option value="cancelled" <?php echo e($booking->status == 'cancelled' ? 'selected' : ''); ?>>Cancel</option>
                                    </select>
                                ...
                                <button onclick="openEditBookingModal(<?php echo e(json_encode($booking)); ?>)" style="padding:0.20rem 0.5rem; font-size:0.75rem; background:#c5a059; color:white; border:none; cursor:pointer; border-radius:4px; font-weight:600; white-space:nowrap;">Edit Details</button>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="contacts-tab" class="tab-content" style="display: none;">
            <div class="panel" style="margin-bottom: 5rem;">
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $contactRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($req->created_at->format('Y-m-d H:i')); ?></td>
                            <td><strong><?php echo e($req->name); ?></strong></td>
                            <td><a href="mailto:<?php echo e($req->email); ?>"><?php echo e($req->email); ?></a></td>
                            <td>
                                <?php if($req->phone): ?>
                                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $req->phone)); ?>" target="_blank"><?php echo e($req->phone); ?></a>
                                <?php else: ?>
                                    <span style="color:var(--text-muted); font-style:italic;">None</span>
                                <?php endif; ?>
                            </td>
                            <td style="max-width: 350px; white-space: normal; word-wrap: break-word;"><?php echo e($req->message); ?></td>
                            <td>
                                <form action="/<?php echo e($locale); ?>/admin/contact-requests/<?php echo e($req->id); ?>" method="POST" onsubmit="return confirm('Delete this contact message request?')" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" style="color:red; background:none; border:none; cursor:pointer; font-weight:600;">Delete</button>
                                </form>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($contactRequests->isEmpty()): ?>
                        <tr>
        ...
        <div id="api-tab" class="tab-content" style="display: none;">
            <div class="admin-grid" style="margin-bottom: 5rem;">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><code><?php echo e($key->key); ?></code></td>
                                <td><strong style="color: var(--accent-gold);"><?php echo e($key->discount_percent); ?>% discount</strong></td>
                                <td>
                                ...
                                <td style="color: var(--text-muted);"><?php echo e($key->created_at->format('Y-m-d H:i')); ?></td>
                                <td>
                                    <button type="button" onclick="openEditApiKeyModal(<?php echo e(json_encode($key)); ?>)" style="color:var(--primary-blue); background:none; border:none; cursor:pointer; font-weight:600; margin-right:15px;">Edit</button>
                                    <form action="/<?php echo e($locale); ?>/admin/api-keys/<?php echo e($key->id); ?>" method="POST" onsubmit="return confirm('Revoke this API key? External systems using this key will immediately lose access!')" style="display:inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                ...
                <div class="panel">
                    ...
                    <form action="/<?php echo e($locale); ?>/admin/api-keys" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                    ...
                    <div style="margin-top: 2rem; background: var(--bg-light); border: 1px solid var(--border-color); border-radius: 8px; padding: 1.25rem;">
                        ...
                        <p style="font-size: 0.8rem; line-height: 1.5; color: var(--text-muted); margin-bottom: 0.5rem;">
                            ...
                            <br><code><?php echo e(url('/api/booking')); ?></code>
                        </p>
            ...
            <div class="admin-grid" style="margin-bottom: 5rem; border-top: 2px solid var(--border-color); padding-top: 3rem;">
                <div class="panel">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $partnerSites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="text-align:center;">
                                    <span style="display:inline-block; width:28px; height:28px; line-height:28px; border-radius:50%; background:#2563eb; color:white; font-size:0.75rem; font-weight:700; text-align:center;" title="Homepage display priority — edit partner to change">
                                        <?php echo e($partner->display_order ?? 99); ?>

                                    </span>
                                </td>
                                <td><strong><?php echo e($partner->name); ?></strong></td>
                                <td><code><?php echo e($partner->api_url); ?></code></td>
                                <td><strong style="color: var(--accent-gold);">+<?php echo e($partner->markup_percent); ?>%</strong></td>
                                <td>
                                    <span style="background: rgba(16, 185, 129, 0.15); color: #10b981; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600; font-size: 0.75rem;">
                                        Connected
                                    </span>
                                ...
                                <td>
                                    <button type="button" onclick="openEditPartnerModal(<?php echo e(json_encode($partner)); ?>)" style="color:var(--primary-blue); background:none; border:none; cursor:pointer; font-weight:600; margin-right:15px;">Edit</button>
                                    <form action="/<?php echo e($locale); ?>/admin/partner-sites/<?php echo e($partner->id); ?>" method="POST" onsubmit="return confirm('Remove this partner connection? Their cars will immediately disappear from your homepage!')" style="display:inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                ...
                <div class="panel">
                    ...
                    <form action="/<?php echo e($locale); ?>/admin/partner-sites" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
        ...
        <div id="blog-tab" class="tab-content" style="display: none;">
            <div class="admin-grid" style="margin-bottom: 5rem;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size:0.75rem; color:var(--text-muted);">/<?php echo e($post->locale); ?>/blog/<?php echo e($post->slug); ?></div>
                                </td>
                                <td>
                                ...
                                <td><strong><?php echo e(strtoupper($post->locale)); ?></strong></td>
                                <td>
                                    <span style="background: <?php echo e($post->is_published ? 'rgba(16, 185, 129, 0.15)' : '#fee2e2'); ?>; color: <?php echo e($post->is_published ? '#10b981' : '#ef4444'); ?>; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600; font-size: 0.75rem;">
                                        <?php echo e($post->is_published ? 'Published' : 'Draft'); ?>

                                    </span>
                                </td>
                                <td>
                                    <a href="/<?php echo e($post->locale); ?>/blog/<?php echo e($post->slug); ?>" target="_blank" style="color: #10b981; margin-right: 0.5rem; text-decoration: none; font-weight: 600;">View</a>
                                    <button type="button" onclick="openEditBlogModal(<?php echo e(json_encode($post)); ?>)" style="color:var(--accent-gold); background:none; border:none; cursor:pointer; font-weight:600; margin-right:0.5rem;">Edit</button>
                                    <form action="/<?php echo e($locale); ?>/admin/blog-posts/<?php echo e($post->id); ?>" method="POST" onsubmit="return confirm('Delete this blog post?')" style="display:inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" style="color:red; background:none; border:none; cursor:pointer; font-weight:600;">Delete</button>
                                    </form>
                ...
                <div class="panel">
                    ...
                    <form action="/<?php echo e($locale); ?>/admin/blog-posts" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="editCarForm" method="POST" action="">
                ...
                <div style="display: flex; gap: 1rem;">
                    <div class="form-group" style="flex: 1;">
                        <label>Model Year <span style="font-size:0.72rem; color:var(--text-muted);">(for inspection tracking)</span></label>
                        <input type="number" name="model_year" id="edit_model_year" min="2000" max="<?php echo e(date('Y')); ?>" placeholder="<?php echo e(date('Y')); ?>">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label>Model Month</label>
    ...
    <div id="manualBookingModal" class="modal">
        <div class="modal-content">
            ...
            <form action="/<?php echo e($locale); ?>/admin/bookings/manual" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label>Select Car Model</label>
                    <select name="car_id" required>
                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($car->id); ?>"><?php echo e($car->brand); ?> <?php echo e($car->model); ?> (Rate: <?php echo e($car->base_price); ?> DH/day)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        const revenueData = <?php echo json_encode($revenueByMonth, 15, 512) ?>;
        ...
        <div class="modal-content" style="max-width: 700px;">
            ...
            <div style="display: flex; gap: 2rem; margin-bottom: 2rem;">
                <div style="flex: 1; background: var(--bg-light); padding: 1.2rem; border-radius: 8px; border: 1px solid var(--border-color);">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <?php $__currentLoopData = $topCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom: 1px solid rgba(0,0,0,0.05);">
                            <td style="padding: 0.5rem 0; font-size: 0.85rem;"><strong><?php echo e($tc->country); ?></strong></td>
                            <td style="padding: 0.5rem 0; font-size: 0.85rem; text-align: right; color: var(--accent-gold); font-weight:700;"><?php echo e($tc->count); ?> visits</td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </table>
                </div>
            ...
            <div style="max-height: 250px; overflow-y: auto; border: 1px solid var(--border-color); border-radius: 8px;">
                <table style="width: 100%; border-collapse: collapse; font-size: 0.8rem;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allVisits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom: 1px solid rgba(0,0,0,0.05); background: white;">
                            <td style="padding: 0.4rem 0.5rem;"><code><?php echo e($visit->ip_address); ?></code></td>
                            <td style="padding: 0.4rem 0.5rem;"><?php echo e($visit->country); ?></td>
                            <td style="padding: 0.4rem 0.5rem; color: var(--text-muted);"><?php echo e($visit->visited_at->format('Y-m-d H:i:s')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php /**PATH C:\Users\ASUS\Documents\GitHub\Car-rental\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>