...
<?php echo e($seoTitle ?? __('messages.hero_title') . ' | Car Airport Morocco'); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta_description'); ?>
<?php echo e($seoDescription ?? 'Rent a car at Marrakech Airport from 250 DH per day. Free airport delivery, full insurance, unlimited mileage, and direct WhatsApp booking.'); ?>
...
<section class="hero">
    ...
    <p><?php echo e(__('messages.hero_subtitle')); ?></p>
    ...
    <div class="hero-features">
        <div class="hero-feature-item">
            ...
            <?php echo e(__('messages.no_hidden_fees')); ?>
        ...
        <div class="hero-feature-item">
            ...
            <?php echo e(__('messages.unlimited_mileage')); ?>
        ...
        <div class="hero-feature-item">
            ...
            <?php echo e(__('messages.support_24_7')); ?>
...
<div class="search-widget-container" id="search">
    <form class="search-widget" method="GET" action="/<?php echo e($locale); ?>#cars">
        <div class="search-grid">
            <div class="form-group">
                <label for="pickup_location"><?php echo e(__('messages.pickup_location')); ?></label>
                <div class="input-wrapper">
                    <select name="pickup_location" id="pickup_location">
                        <option value="Marrakech Airport (RAK)" <?php echo e($searchParams['pickup_location'] == 'Marrakech Airport (RAK)' ? 'selected' : ''); ?>>Marrakech Airport (RAK)</option>
                        <option value="Casablanca Airport (CMN)" <?php echo e($searchParams['pickup_location'] == 'Casablanca Airport (CMN)' ? 'selected' : ''); ?>>Casablanca Airport (CMN)</option>
                        <option value="Agadir Airport (AGA)" <?php echo e($searchParams['pickup_location'] == 'Agadir Airport (AGA)' ? 'selected' : ''); ?>>Agadir Airport (AGA)</option>
                        <option value="Tanger Airport (TNG)" <?php echo e($searchParams['pickup_location'] == 'Tanger Airport (TNG)' ? 'selected' : ''); ?>>Tanger Airport (TNG)</option>
                    </select>
                </div>
            ...
            <div class="form-group">
                <label for="pickup_date"><?php echo e(__('messages.pickup_date')); ?></label>
                <div class="input-wrapper" style="display: flex; gap: 0.5rem;">
                    <input type="date" name="pickup_date" id="pickup_date" value="<?php echo e($searchParams['pickup_date']); ?>" style="flex: 2;">
                    <input type="time" name="pickup_time" id="pickup_time" value="<?php echo e($searchParams['pickup_time']); ?>" style="flex: 1; min-width: 80px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper" style="display: flex; gap: 0.5rem;">
                    <input type="date" name="return_date" id="return_date" value="<?php echo e($searchParams['return_date']); ?>" style="flex: 2;">
                    <input type="time" name="return_time" id="return_time" value="<?php echo e($searchParams['return_time']); ?>" style="flex: 1; min-width: 80px;">
                </div>
            </div>
            
            <div class="form-group">
                <label for="driver_age"><?php echo e(__('messages.driver_age')); ?></label>
                <div class="input-wrapper">
                    <select name="driver_age" id="driver_age">
                        <option value="25+" <?php echo e($searchParams['driver_age'] == '25+' ? 'selected' : ''); ?>>25+</option>
                        <option value="21-24" <?php echo e($searchParams['driver_age'] == '21-24' ? 'selected' : ''); ?>>21-24</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div style="margin-top: 1.5rem; display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
            <div style="flex-grow: 1;">
                <button type="submit" class="search-btn">
                    ...
                    <?php echo e(__('messages.search_cars')); ?>
        ...
        <div class="search-widget-footer">
            <div>
                ...
                <?php echo e(__('messages.free_cancellation')); ?>
            ...
            <div>
                ...
                <?php echo e(__('messages.best_price_guarantee')); ?>
...
<section class="section-container" id="cars">
    <div class="section-header">
        <h2><?php echo e(__('messages.featured_cars')); ?></h2>
    ...
    <div class="cars-grid">
        ...
        <div class="car-card" data-category="<?php echo e($car->category); ?>" data-trans="<?php echo e($car->transmission); ?>" data-supplier="<?php echo e(strtolower($car->company_name ?? "")); ?>" data-rating="<?php echo e($car->company_rating ?? 10.0); ?>" data-sort-order="<?php echo e($car->pertinence_rank ?? 0); ?>" data-price="<?php echo e($car->total_price ?? 0); ?>" style="transition: opacity 0.3s ease, transform 0.3s ease;">
            <div class="car-image-container">
                <!-- Dynamic Availability Badge -->
                <?php if(isset($car->total_bookings_count) && isset($car->quantity)): ?>
                    <?php
                        $remaining = max(0, $car->quantity - $car->total_bookings_count);
                    ?>
                    <?php if($remaining === 0 && !$car->allow_overbooking): ?>
                        <div class="car-badge" style="background-color: #dc3545; color: white;">Fully Booked</div>
                    <?php elseif($remaining === 1 && !$car->allow_overbooking): ?>
                ...
                <!-- Static car photo -->
                <img src="<?php echo e($car->image_path); ?>" alt="<?php echo e($car->brand); ?> <?php echo e($car->model); ?>" onerror="this.src='https://placehold.co/400x250/0f1d36/c5a059?text=<?php echo e($car->brand); ?>+<?php echo e($car->model); ?>'">
                
                <!-- Hover Loop Muted Video / GIF preview -->
                <?php if($car->video_path): ?>
                <video muted loop playsinline src="<?php echo e($car->video_path); ?>"></video>
                <?php endif; ?>
            </div>
            ...
            <div class="car-details">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem;">
                    <div style="display: flex; align-items: center; gap: 0.4rem;">
                        <?php if(!empty($car->company_logo)): ?>
                            <img src="<?php echo e($car->company_logo); ?>" alt="<?php echo e($car->company_name); ?>" style="height: 16px; width: 16px; object-fit: contain; border-radius: 2px;">
                        <?php else: ?>
                            <span style="font-size: 0.85rem;">🏢</span>
                        <?php endif; ?>
                        <span style="font-size: 0.75rem; font-weight: 700; color: var(--accent-gold); letter-spacing: 0.5px; text-transform: uppercase;"><?php echo e($car->company_name); ?></span>
                    </div>
                </div>
                <div class="car-title-row">
                    <h3><?php echo e($car->brand); ?> <?php echo e($car->model); ?></h3>
                </div>
                <div class="car-subtitle"><?php echo e(__('messages.or_similar')); ?></div>
                
                <div class="car-specs">
                    <div class="spec-item">
                        👥 <?php echo e($car->seats); ?> <?php echo e(__('messages.seats')); ?>

                    </div>
                    <div class="spec-item">
                        ⚙️ <?php echo e($car->transmission == 'Manual' ? __('messages.manual') : __('messages.automatic')); ?>

                    </div>
                    <div class="spec-item">
                        ❄️ <?php echo e(__('messages.ac')); ?>
                    ...
                    <div class="spec-item">
                        🧳 <?php echo e($car->category === 'SUV' ? '4' : ($car->category === 'Van' ? '5' : ($car->category === 'Luxury' ? '3' : '2'))); ?> Bags
                    </div>
                </div>
                
                <div class="car-price-row">
                    <div class="price-box">
                        <div class="price-amount"><span class="price-val" data-base-mad="<?php echo e($car->display_price); ?>"><?php echo e(round($car->display_price)); ?></span> <span class="currency-label">DH</span> <span>/ <?php echo e(__('messages.day')); ?></span></div>
                        <?php if(isset($car->total_price) && $car->days > 1): ?>
                        <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.25rem;">Total: <span class="price-val" data-base-mad="<?php echo e($car->total_price); ?>"><?php echo e(round($car->total_price)); ?></span> <span class="currency-label">DH</span> (<?php echo e($car->days); ?> days)</div>
                        <?php endif; ?>
                    </div>
                    
                    <div class="action-buttons">
                        <a href="#" class="book-btn" onclick="openBookingModal('<?php echo e($car->id); ?>', '<?php echo e($car->brand); ?> <?php echo e($car->model); ?>', '<?php echo e($car->display_price); ?>')">
                            <?php echo e(__('messages.book_now')); ?>

                        </a>
                        <!-- WHATSAPP CTA - Formats prefilled request automatically -->
                        <a href="#" class="whatsapp-btn" data-car="<?php echo e($car->brand); ?> <?php echo e($car->model); ?>" data-price="<?php echo e($car->display_price); ?>" data-phone="<?php echo e(config('app.whatsapp_phone', '+212600988632')); ?>">
                            ...
                            <?php echo e(__('messages.book_whatsapp')); ?>
...
<section class="why-choose" id="why-choose">
    <div class="section-container">
        <h2 style="text-align: center; font-family: var(--font-heading); font-size: 2.2rem; color: var(--primary-blue); margin-bottom: 3rem;">
            <?php echo e(__('messages.why_choose_title')); ?>
        ...
        <div class="why-choose-grid">
            <div class="why-card">
                ...
                <h3><?php echo e(__('messages.reason_1_title')); ?></h3>
                <p><?php echo e(__('messages.reason_1_desc')); ?></p>
            </div>
            
            <div class="why-card">
                <div class="why-icon">🛡️</div>
                <h3><?php echo e(__('messages.reason_2_title')); ?></h3>
                <p><?php echo e(__('messages.reason_2_desc')); ?></p>
            </div>
            
            <div class="why-card">
                <div class="why-icon">🔄</div>
                <h3><?php echo e(__('messages.reason_3_title')); ?></h3>
                <p><?php echo e(__('messages.reason_3_desc')); ?></p>
            </div>
            
            <div class="why-card">
                <div class="why-icon">📞</div>
                <h3><?php echo e(__('messages.reason_4_title')); ?></h3>
                <p><?php echo e(__('messages.reason_4_desc')); ?></p>
            </div>
        ...
        <div class="car-card" data-category="<?php echo e($car->category); ?>" data-trans="<?php echo e($car->transmission); ?>" data-supplier="<?php echo e(strtolower($car->company_name ?? "")); ?>" data-rating="<?php echo e($car->company_rating ?? 10.0); ?>" data-sort-order="<?php echo e($car->pertinence_rank ?? 0); ?>" data-price="<?php echo e($car->total_price ?? 0); ?>" style="transition: opacity 0.3s ease, transform 0.3s ease;">
            ...
            <div class="car-details">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem;">
                    ...
                    <?php if(isset($car->company_rating) && $car->company_rating !== null): ?>
                        <div style="background: #28c76f; color: white; padding: 0.15rem 0.35rem; border-radius: 4px; font-size: 0.75rem; font-weight: 700; display: flex; align-items: center; gap: 2px;" title="Supplier Rating">
                            ⭐ <?php echo e(number_format($car->company_rating, 1)); ?>
...
<section class="why-choose" id="why-choose">
    <div class="section-container">
        ...
        <div class="why-choose-grid">
            ...
            <div class="why-card">
                <div class="why-icon">💳</div>
                <h3><?php echo e(__('messages.reason_5_title')); ?></h3>
                <p><?php echo e(__('messages.reason_5_desc')); ?></p>
            </div>
            
            <div class="why-card">
                <div class="why-icon">🏷️</div>
                <h3><?php echo e(__('messages.reason_6_title')); ?></h3>
                <p><?php echo e(__('messages.reason_6_desc')); ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="promo-testimonials" id="testimonials">
    <div class="promo-banner">
        <h2><?php echo e(__('messages.explore_title')); ?></h2>
        <p><?php echo e(__('messages.explore_desc')); ?></p>
        <a href="#search" class="promo-link"><?php echo e(__('messages.discover_more')); ?></a>
    </div>
    
    <div class="testimonials">
        <div class="testimonials-header">
            <div>
                <h2><?php echo e(__('messages.customer_says')); ?></h2>
                <div class="rating-platforms">
                    <a href="<?php echo e($reviews['url']); ?>" target="_blank" rel="noopener" style="color: inherit; text-decoration: underline; font-weight: 600;">
                        Google (<?php echo e($reviews['rating']); ?>/5 · <?php echo e($reviews['count']); ?> reviews)
                    </a>
                </div>
            </div>
            <a href="<?php echo e($reviews['url']); ?>" target="_blank" rel="noopener" style="text-decoration: none; color: inherit; text-align: right;" class="rating-summary">
                <div class="rating-number"><?php echo e($reviews['rating']); ?></div>
                <div class="stars">★★★★★</div>
                <div style="font-size: 0.72rem; color: var(--text-muted); text-decoration: underline;"><?php echo e(__('messages.based_on')); ?></div>
            </a>
        </div>

        <div class="review-slider" style="position:relative;">
            <?php $__currentLoopData = $reviews['reviews']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="review-slide" style="<?php echo e($idx > 0 ? 'display:none;' : ''); ?>">
                <div style="display:flex; gap:0.25rem; margin-bottom:0.6rem;">
                    <?php for($s = 1; $s <= 5; $s++): ?>
                        <span style="color:<?php echo e($s <= ($review['rating'] ?? 5) ? '#ffc107' : '#e2e8f0'); ?>; font-size:1rem;">★</span>
                    <?php endfor; ?>
                </div>
                <p class="review-text">"<?php echo e($review['text']); ?>"</p>
                <div class="reviewer-meta">
                    <div class="reviewer-avatar"><?php echo e($review['avatar_initial']); ?></div>
                    <div class="reviewer-info">
                        <h4><?php echo e($review['author']); ?></h4>
                        <span><?php echo e($review['time']); ?> · Google</span>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php if(count($reviews['reviews']) > 1): ?>
            <div style="display:flex; gap:0.5rem; margin-top:1.25rem; align-items:center;">
                ...
                <?php $__currentLoopData = $reviews['reviews']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $di => $__): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="review-dot" data-idx="<?php echo e($di); ?>" onclick="goReview(<?php echo e($di); ?>)" style="width:8px;height:8px;border-radius:50%;background:<?php echo e($di === 0 ? 'var(--primary-blue)' : '#cbd5e1'); ?>;cursor:pointer;transition:background 0.2s;"></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="section-container" id="contact-form" style="margin-top: 5rem; margin-bottom: 5rem;">
    <div style="background: var(--bg-white); border: 1px solid var(--border-color); border-radius: 12px; padding: 3rem; max-width: 800px; margin: 0 auto; box-shadow: var(--shadow-lg);">
        ...
        <form action="/<?php echo e($locale); ?>/contact" method="POST" style="display: flex; flex-direction: column; gap: 1.25rem;">
            <?php echo csrf_field(); ?>
...
<div id="bookingModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 10000; justify-content: center; align-items: center; padding: 1.5rem;">
    <div style="background: white; padding: 2rem; border-radius: 12px; max-width: 500px; width: 100%; position: relative; box-shadow: var(--shadow-lg); color: #333;">
        ...
        <form id="bookingForm" method="POST" action="/<?php echo e($locale); ?>/book">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 1.25rem; background: #f8fafc; padding: 0.85rem; border-radius: 8px; border: 1px solid #e2e8f0;">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.4rem;" id="modalExtrasContainer">
                    ...
                    <label style="display: flex; justify-content: space-between; align-items: center; font-size: 0.78rem; font-weight: 600; cursor: pointer; color: #475569; margin: 0;">
                        <span>
                            <?php if($extra->slug == 'insurance'): ?> 🛡️ <?php elseif($extra->slug == 'gps'): ?> 🗺️ <?php elseif($extra->slug == 'child_seat'): ?> 👶 <?php else: ?> 👤 <?php endif; ?>
                            <?php echo e($extra->name); ?> (+<?php echo e(round($extra->price)); ?> DH/<?php echo e($extra->type == 'per_day' ? 'day' : 'flat'); ?>)
                        </span>
                        <input type="checkbox" name="extras[]" value="<?php echo e($extra->slug); ?>" id="extra_<?php echo e($extra->slug); ?>" data-price="<?php echo e($extra->price); ?>" data-type="<?php echo e($extra->type); ?>" onchange="updateBookingModalPrice()" style="width: auto; cursor: pointer;">
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\Car-rental\resources\views/home.blade.php ENDPATH**/ ?>