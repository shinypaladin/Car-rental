...
<head>
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Car Airport Morocco - Rent a Car at Marrakech Airport'); ?>" />
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Rent a car at Marrakech Airport from 350 DH per day. Free airport delivery, full insurance, unlimited mileage, and direct WhatsApp booking.'); ?>" />
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', 'Car Airport Morocco - Rent a Car at Marrakech Airport'); ?>" />
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', 'Rent a car at Marrakech Airport from 350 DH per day. Free airport delivery, full insurance, unlimited mileage, and direct WhatsApp booking.'); ?>" />
...
#manageBookingModal input::placeholder, #bookingModal input::placeholder {
    ...
    <script type="application/ld+json">
        <?php echo \App\Helpers\SeoHelper::getSchemaMarkup(); ?>
...
<body>
        ...
        <div class="header-container">
            ...
            <div class="header-actions">
                ...
                <select class="lang-selector" id="lang-select">
                    ...
                    <option value="fr" <?php echo e($locale === 'fr' ? 'selected' : ''); ?>>🇫🇷 Français</option>
                    <option value="de" <?php echo e($locale === 'de' ? 'selected' : ''); ?>>🇩🇪 Deutsch</option>
                </select>

                <!-- Theme Toggle Button -->
                <button class="lang-selector" id="theme-toggle-btn" title="Toggle Theme" style="font-size: 1.1rem; padding: 0.35rem 0.65rem;">🌓</button>
                
                <a href="#" onclick="openManageBookingModal(); return false;" class="booking-btn"><?php echo e(__('messages.my_booking')); ?></a>
            </div>
        </div>
    </header>
    ...
    <div class="floating-whatsapp" data-phone="<?php echo e(config('app.whatsapp_phone', '+212600988632')); ?>" title="Chat on WhatsApp">
    ...
    <footer>
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Information</h4>
                <ul>
                    <li><a href="<?php echo e(route('faq', ['locale' => $locale])); ?>">FAQ</a></li>
                    <li><a href="<?php echo e(route('terms', ['locale' => $locale])); ?>">Terms & Conditions</a></li>
                    <li><a href="<?php echo e(route('privacy', ['locale' => $locale])); ?>">Privacy Policy</a></li>
                    <li><a href="<?php echo e(route('cookie', ['locale' => $locale])); ?>">Cookie Policy</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col footer-contact" style="grid-column: span 2;">
                ...
                <ul>
                    <li>
                        ...
                        <?php echo e(config('app.whatsapp_phone', '+212600988632')); ?>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> Car Airport Morocco. All rights reserved.</p>
        </div>
    </footer>
                ...
                <form id="publicBookingEditForm" onsubmit="submitPublicBookingUpdate(event)">
                    ...
                    <div style="margin-bottom: 1rem; background: #faf7f2; padding: 0.85rem; border-radius: 8px; border: 1px solid rgba(197,160,89,0.2); color: #333;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.4rem;" id="publicEditExtrasContainer">
                            <?php $__currentLoopData = $layoutExtras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label style="display: flex; justify-content: space-between; align-items: center; font-size: 0.78rem; font-weight: 600; cursor: pointer; color: #475569; margin: 0;">
                                ...
                                <input type="checkbox" id="publicEditExtra_<?php echo e($extra->slug); ?>" data-slug="<?php echo e($extra->slug); ?>" onchange="triggerPriceRecalculation()" style="width: auto; cursor: pointer;">
                            </label>
    ...
    <script>
        ...
        <?php if(session('whatsapp_redirect_url')): ?>
            setTimeout(function() {
                window.open("<?php echo e(session('whatsapp_redirect_url')); ?>", '_blank');
            }, 1000);
        <?php endif; ?>

        // Save fresh bookings done in this session to device history
        <?php if(session('last_booking_reference')): ?>
