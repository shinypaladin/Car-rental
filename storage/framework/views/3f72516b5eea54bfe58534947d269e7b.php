<?php $__env->startSection('title', 'Cookie Policy - Car Airport Morocco'); ?>
<?php $__env->startSection('meta_description', 'Cookie Policy for Car Airport Morocco. Understand how we use cookies to save your booking references and language preferences.'); ?>
...
<div class="section-container" style="max-width: 800px; margin: 3rem auto 6rem auto; padding: 0 1.5rem;">
    <h1 style="font-family: var(--font-heading); font-size: 2.5rem; color: var(--primary-blue); margin-bottom: 2rem; font-weight: 800; text-align: center;">
        <?php echo e($locale === 'fr' ? 'Politique relative aux Cookies' : 'Cookie Policy'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\Car-rental\resources\views/cookie.blade.php ENDPATH**/ ?>