...
@section('title', 'About Us - Car Airport Morocco')
@section('meta_description', 'Learn about Car Airport Morocco. Premium car rental services in Marrakech specializing in personalized Meet and Greet airport and hotel delivery.')
