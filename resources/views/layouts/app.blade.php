...
.hero{position:relative;background:linear-gradient(rgba(0,0,0,0.3),rgba(15,29,54,0.8));min-height:480px;padding:5rem 1.5rem 10rem;color:var(--text-white);text-align:center;background-color:var(--primary-blue)}
...
<body>
    ...
    <div class="floating-whatsapp" data-phone="{{ config('app.whatsapp_phone', '+2126000988632') }}" title="Chat on WhatsApp">
            ...
            <div class="footer-col footer-contact" style="grid-column: span 2;">
                ...
                <ul>
                    <li>
                        ...
                        {{ config('app.whatsapp_phone', '+2126000988632') }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
