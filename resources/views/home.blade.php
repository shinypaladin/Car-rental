            ...
            <div class="car-details">
                ...
                <div class="car-price-row">
                    ...
                    <div class="action-buttons">
                        @if(!empty($car->is_affiliate))
                            <a href="{{ $car->affiliate_url ?: '#' }}" target="_blank" rel="noopener" class="book-btn" style="background-color: var(--accent-gold); color: white; display: flex; align-items: center; justify-content: center; gap: 0.35rem;">
